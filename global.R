...
default.cols <- list(
  ...
  "Library Preparation" = c("sample_accession", "library_accession", "library_number", "library_plate", "library_well", "library_date", "library_year", "library_month", "library_day", "library_prep_lab", "library_by", "library_source", "library_type", "library_method", "library_selection", "library_description", "library_layout", "library_index_plate", "library_index", "library_volume_ul", "library_conc_ng_ul_1", "library_conc_ng_ul_2", "library_quality1", "library_quality2"),
